...
public final class Bundler {
    ...
    throws IOException {
        ...
        //
        String fileName = "/InteractionShield/artifact/Intermediate/config/app_bundles.json";
        List<List<String>> resultBundles = new ArrayList<>();
        ...
        try {
            ...
            Map<String, Map<String, List<String>>> allData = gson.fromJson(jsonContent, type);

            String sizeKey = String.valueOf(size);
            if (allData.containsKey(sizeKey)) {
                Map<String, List<String>> iterations = allData.get(sizeKey);
                resultBundles.addAll(iterations.values());
            }
