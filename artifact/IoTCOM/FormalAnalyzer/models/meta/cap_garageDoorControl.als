...
one sig cap_garageDoorControl_attr_garageDoorControl extends cap_garageDoorControl_attr {}
{
    values = cap_garageDoorControl_attr_garageDoorControl_val
} 
abstract sig cap_garageDoorControl_attr_garageDoorControl_val extends AttrValue {}
one sig cap_garageDoorControl_attr_garageDoorControl_val_closed extends cap_garageDoorControl_attr_garageDoorControl_val {}
one sig cap_garageDoorControl_attr_garageDoorControl_val_closing extends cap_garageDoorControl_attr_garageDoorControl_val {}
one sig cap_garageDoorControl_attr_garageDoorControl_val_open extends cap_garageDoorControl_attr_garageDoorControl_val {}
one sig cap_garageDoorControl_attr_garageDoorControl_val_opening extends cap_garageDoorControl_attr_garageDoorControl_val {}
one sig cap_garageDoorControl_attr_garageDoorControl_val_unknown extends cap_garageDoorControl_attr_garageDoorControl_val {}
